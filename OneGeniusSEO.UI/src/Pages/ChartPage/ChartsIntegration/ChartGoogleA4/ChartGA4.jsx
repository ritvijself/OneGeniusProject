...
const ChartGA4 = ({
  ...
  TotalUserMap,
  sessions,
  // <<<<<< CHANGE #1: Saare purane ref props hata diye gaye hain >>>>>>
  // <<<<<< Aur sirf 'setChartRef' prop liya gaya hai >>>>>>
  setChartRef,
}) => {
  ...
  return (
    <>
        ...
        <Col md={12}>
          <div ref={(el) => setChartRef('ga4_channeltable', el)}>
            <ChannelTable
              ...
              endDate={endDate}
              columns={[
                { key: "channel", label: "Channel" }, { key: "sessions", label: "Sessions" }, { key: "totalUsers", label: "Total Users" }, { key: "userEngagementDuration", label: "User Engagement" }, { key: "screenPageViews", label: "Views" }, { key: "eventCount", label: "Event Count" }, { key: "keyEvents", label: "Key Events" }, { key: "ecommercePurchases", label: "Total Purchasers" },
              ]}
            />
          </div>
        </Col>
      ...
      <Row className="mt-3" style={{ marginBottom: "50px" }}>
        ...
        <Col md={4} key={ConversionRate[0].id}>
          <Col md={12} key={UserEngagementDayByDay[0].id} className="mb-3">
            <div ref={(el) => setChartRef('ga4_bounceengagementmetricbox', el)} >
        ...
        <Col md={12}>
          <div ref={(el) => setChartRef('ga4_devicetable', el)}>
            <DeviceTable
              ...
              columns={[
                { key: "campaign", label: "Campaign" }, { key: "conversions", label: "Conversions" }, { key: "newUsers", label: "New Users" }, { key: "totalUsers", label: "Total Users" }, { key: "userEngagementDuration", label: "Engagement Duration" },
              ]}
            />
          </div>
        </Col>
      ...
      {/* where your visitors are located section */}
      <div className={`${style.table_heading} mb-5`}>
      ...
      {/* <<<<<< CHANGE #3: MAP LOOP WALE SPECIAL CASE KO THEEK KIYA GAYA HAI >>>>>> */}
      <div ref={(el) => setChartRef('ga4_progressbar2', el)}>
        <Row className="mt-3">
          {TotalUserByLanguage.map((Data) => (
      ...
      {/* <<<<<< CHANGE #4: YAHAN BHI MAP LOOP KO THEEK KIYA GAYA HAI >>>>>> */}
        ...
        <Col md={12}>
          <div ref={(el) => setChartRef('ga4_devicetable1', el)}>
            <DeviceTable
              ...
              columns={[
                { key: "deviceCategory", label: "Device Category" }, { key: "sessions", label: "Session" }, { key: "totalUsers", label: "Total Users" }, { key: "userEngagementDuration", label: "User Engagement (s)", }, { key: "views", label: " Views" }, { key: "engagementRate", label: "Key Events" }, { key: "eventCount", label: "Event Count" },
              ]}
            />
          </div>
        </Col>
        ...
        <Col md={12}>
          <div ref={(el) => setChartRef('ga4_devicetable2', el)}>
            <DeviceTable
              ...
              endDate={endDate}
              columns={[
                { key: "pagePath", label: "Pages" }, { key: "sessions", label: "Sessions" }, { key: "totalUsers", label: "Total Users" }, { key: "userEngagementDuration", label: "User Engagement" }, { key: "screenPageViews", label: "Views" }, { key: "eventCount", label: "Event Count" }, { key: "keyEvents", label: "Key Events" }, { key: "ecommercePurchases", label: "Purchases" },
              ]}
            />
          </div>
        </Col>
