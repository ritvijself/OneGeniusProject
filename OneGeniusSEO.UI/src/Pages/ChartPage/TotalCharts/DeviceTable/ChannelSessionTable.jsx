  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        result.forEach(({ sessionDefaultChannelGroup, month, sessions }) => {
          ...
          const monthYear = `${monthName} ${resolvedYear}`;
        ...
        const monthArray = [...monthsSet].sort((a, b) => {
          ...
          const indexA = Object.values(monthNames).indexOf(monthA);
          const indexB = Object.values(monthNames).indexOf(monthB);
