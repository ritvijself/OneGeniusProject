...
function NavbarLayout({ pageTitle }) {
  ...
  if (
    !companyName || // null, undefined, empty string
    companyName.trim() === "" || // only spaces
    companyName.trim().toLowerCase() === "null" // string "null" (case-insensitive)
  ) {
  ...
  return (
    <>
      {/* TOP BAR: Logo (left) and User dropdown (right) */}
      <Navbar
        expand="lg"
      ...
      {/* BOTTOM BAR: Company name (left) and Client dropdown (right) */}
      <div className="w-100">
        <div
          className="py-2"
          style={{
        ...
        >
          <Container
            ...
            className="d-flex justify-content-between align-items-center"
          >
            <span className="fw-bold text-white">{companyName}</span>
