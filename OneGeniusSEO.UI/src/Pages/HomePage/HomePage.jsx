...
import { FaChartBar, FaClipboardList, FaUsers, FaTachometerAlt, FaChartLine, FaTasks, FaShieldAlt } from "react-icons/fa";
import {
  SiGoogleads,
  SiFacebook,
  SiGoogleanalytics,
        ...
        <Container>
          <Row className="align-items-center g-5">
            <Col lg={7}>
              ...
              >
                Track SEO & PPC performance, manage client projects, and stay on top
                of leads — all from a single, intuitive dashboard.
              </p>
            ...
            <Col md={6} lg={3}>
              <Card className="h-100 shadow-sm border-0 text-center">
                <Card.Body className="d-flex flex-column align-items-center p-4">
                  ...
                  <Card.Text className="text-muted">Key metrics in one place.</Card.Text>
                </Card.Body>
              </Card>
            </Col>
            <Col md={6} lg={3}>
              <Card className="h-100 shadow-sm border-0 text-center">
                <Card.Body className="d-flex flex-column align-items-center p-4">
                  ...
                  <Card.Text className="text-muted">Trends, ROAS, CPA, and LTV.</Card.Text>
                </Card.Body>
              </Card>
            </Col>
            <Col md={6} lg={3}>
              <Card className="h-100 shadow-sm border-0 text-center">
                <Card.Body className="d-flex flex-column align-items-center p-4">
                  ...
                  <Card.Text className="text-muted">Assign, track, and deliver.</Card.Text>
                </Card.Body>
              </Card>
            </Col>
            <Col md={6} lg={3}>
              <Card className="h-100 shadow-sm border-0 text-center">
                <Card.Body className="d-flex flex-column align-items-center p-4">
                  ...
                  <Card.Text className="text-muted">Secure and consistent syncs.</Card.Text>
                </Card.Body>
              </Card>
            </Col>
          </Row>
